...
class MarkerProvider with ChangeNotifier {
  ...
  /// Renvoi le marqueur relié à l'identifiant de l'article
  CustomMarker articleToMarker(String idArticle) {
    return _markers.firstWhere((element) => element.idArticle == idArticle);
  }
}
