...
class MarqueursScreens extends StatefulWidget {
  static const routeName = '/formulaireArticle.dart';

  @override
  _MarqueursScreensState createState() => _MarqueursScreensState();
}

class _MarqueursScreensState extends State<MarqueursScreens> {
  ///  Article à ajouter
  Article article;
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  padding: EdgeInsets.all(3),
                  margin: EdgeInsets.all(2),
                  child: Text('''Nom de l'architecte transformation :''',
                      style: TextStyle(fontSize: 20, fontFamily: 'myriad')),
                ),
                TextFormField(
                  decoration: InputDecoration(
                ...
                TextFormField(
                  decoration: InputDecoration(
                    labelText: 'Nom architecte des Monuments Historiques',
                    border: OutlineInputBorder(),
                  ),
                  controller: monument,
                ),
                ...
                TextFormField(
                  decoration: InputDecoration(
                    labelText: 'Nom de l\'architecte des opérations connexes',
                    border: OutlineInputBorder(),
                  ),
                ...
                TextFormField(
                  decoration: InputDecoration(
                    labelText: 'Nom architecte du patrimoine de l\'oeuvre',
                    border: OutlineInputBorder(),
                  ),
                ...
                Container(
                  padding: EdgeInsets.all(3),
                  margin: EdgeInsets.all(2),
                  child: Text('''Entrez le texte de l'article en anglais :''',
                      style: TextStyle(fontSize: 20, fontFamily: 'myriad')),
                ),
                TextFormField(
                  maxLines: 10,
                          ...
                          onPressed: () {
                            ...
                            if (_formKey.currentState.validate()) {
                              ...
                              article = new Article(
                                  ...
                                  audio: audio != null ? audio.name : '',
                                  audioEN: audioEN != null ? audioEN.name : '',
                                  textEn: textEN.text,
                                  tags: tags,
                                  architecte: architecte.text,
                                  photo: photo.text);

                              String idMarker = Uuid().v4();
      ...
      return Scaffold(
        ...
        body: Scrollbar(
          child: Container(
              ...
              width: double.infinity,
              color: Colors.white,
              child: SingleChildScrollView(child: _formulaireMarqueurs())),
        ),
      );
    } else
      return LoginScreen();
